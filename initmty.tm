...
PARAMETER TM_L(R,T)                    'Annual labor index'                                         //;
PARAMETER TM_TSRV(R,T)                 'Capital survival factor between two periods'                //;
PARAMETER TM_AEEIV(R,T,C)              'Annual Autonomous energy efficiency and demand decoupling factor'     //;
PARAMETER TM_AEEIFAC(R,T,C)            'Periodwise Autonomous energy efficiency and demand decoupling factor' //;
...
PARAMETER TM_DFACT(R,T)                'Utility discount factor'                                    //;
PARAMETER TM_DFACTCURR(R,T)            'Intermediate parameter for the utility discount factor'     //;
