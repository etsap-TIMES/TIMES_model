*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
* Copyright (C) 2026 IEA-ETSAP.  Licensed under GPLv3 (see file NOTICE-GPLv3.txt).
*=============================================================================*
* CUREX.GMS oversees the currency conversions
*   %1 - name of cost attribute
*   %2 - name of temp attribute (set to %1 if no temp used)
*   %3,%4 - region, year index
*   %5 - indexes before CUR
*   %6 - constant indexes before CUR (optional, for temp attribute)
*   %7 - indexes after CUR
*=============================================================================*
...
$BATINCLUDE curex BL_VAROMC BL_VAROMC R '' 'COM'
$BATINCLUDE curex BL_DELIVC BL_DELIVC R '' 'C,COM'
...
*--------------------------------------------------------------------------
$LABEL SUBR
* Before converting, first remove time series filtered out:
$IF %4==LL %1(%3,LL%5,CUR%7)$((%1(%3,'0'%5,CUR%7)<-12)$%1(%3,'0'%5,CUR%7)) = 0;
$IF %4==LL $SET MX $YEARVAL(LL)
$IF NOT DECLARED %2 PARAMETER %2(%3,%4%5,CUR);
$IFI NOT %1==%2 OPTION CLEAR=%2; %2(%3,%4%5%6,CUR) $= %1(%3,%4%5,CUR); OPTION CLEAR=%1;
  %1(%3,%4%5,CUR%7) $= SUM(CURMAP(R,CUR,CURR)$%2(%3,%4%5%6,CURR%7),%2(%3,%4%5%6,CURR%7)*POWER(R_CUREX(R,CURR,CUR),1%MX%));
$IFI %1==%2     %1(%3,%4%5,CUR%7)$(NOT RDCUR(R,CUR)) = 0;
*--------------------------------------------------------------------------
$LABEL FINISH
